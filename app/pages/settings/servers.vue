        ...
        <template #content>
          <div class="p-6 space-y-4">
            ...
            <ul class="text-sm text-muted space-y-1.5 list-disc list-inside">
              ...
              <li>Каждый плагин на сервере должен авторизоваться по уникальному ID — нельзя ставить один и тот же конфиг на два физических сервера, иначе выдача задвоится.</li>
            </ul>
      ...
      <UModal v-model:open="showCreate">
        <template #content>
          <div class="p-6 space-y-4">
            ...
            <UFormField
              label="ID"
              description="Используется плагином как server-id и одновременно как ключ авторизации. 4–64 символа: буквы, цифры, '_', '-'."
            >
              <UInput
